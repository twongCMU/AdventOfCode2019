...
while data[cur_index] != 99:
    ...
    # save
        ...
        data[data[cur_index+1]] = input_val
        cur_index += 2
    elif opcode == 4:
        print("Output: " + str(data[data[cur_index+1]]))
        cur_index += 2
    # jump if true
    elif opcode == 5:
